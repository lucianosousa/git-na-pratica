...
![Pacote de Instalação](imgs/joomla_componente_estrutura_no_pacote.png) 
...
![Parte do site do componente instalado](imgs/joomla_componente_estrutura_site_instalada.png)
...
![Shell do GIT no Pendrive](imgs/shell_git_no_pendrive.pnp)
